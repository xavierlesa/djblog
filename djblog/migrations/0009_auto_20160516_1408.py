...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djblog', '0008_auto_20160420_1805'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='from_category',
            field=models.ForeignKey(related_name='from_category', to='djblog.Category'),
        ),
        migrations.AddField(
            model_name='categoryrelationship',
            name='to_category',
            field=models.ForeignKey(related_name='to_category', to='djblog.Category'),
        ),
        migrations.AddField(
            model_name='category',
            name='parent',
